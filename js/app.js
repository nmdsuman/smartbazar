      ...
      card.innerHTML = `
        ...
        <div class="action-bar absolute bottom-2 left-2 right-2 z-10">
          ...
          <div class="flex items-center justify-end">
            <button class="add-to-cart ${out ? 'bg-gray-300 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'} text-white w-10 h-10 rounded-full shadow-md flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 active:scale-[0.98] transition" ${out ? 'disabled' : ''} aria-label="Add to cart">
